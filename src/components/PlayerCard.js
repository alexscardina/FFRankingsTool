...
export default function PlayerCard({ player, onClick, platform, isDraftMode, onTheirTeam, onYourTeam, isRosterFilled }) {
  ...
  return (
    <>
      {isDraftMode && (
        <div>
          <button
            onClick={() => onTheirTeam(id)}
            className="their-team-button"
          >
            Their Team
          </button>
          <button
            onClick={() => onYourTeam(id)}
            className="your-team-button"
            disabled={isRosterFilled}
          >
            Your Team
          </button>
        </div>
        ...
        <div style={{display: "flex"}}>
          <div className="player-info">
            ...
            <div className="player-meta">
              {positionString} <div className={positionCircleClass}/>· {team} · Bye: {bye}
            </div>
          </div>
          <img
            src={teamLogo}
